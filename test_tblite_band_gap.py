#!/usr/bin/env python3
"""
Test script for TBLite band gap calculator
...
from tblite_band_gap_calculator import TBLiteBandGapCalculator
import ase.io
import numpy as np

def test_single_structure():
    """Test band gap calculation with a single structure"""
    print("Testing TBLite band gap calculator with single CdS structure...")
